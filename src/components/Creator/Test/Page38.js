          ...
          <div className="upper-inner">
              <Container>
                <Row>
                  ...
                  <Col lg={2} xs={12}>
                  <span><strong>16 Days</strong></span><br></br>
              ...
              <div class=" fun-fact-new-heading">
                 <small><stronng>Proposed Milestone</stronng></small>
               <Row>
                ...
                <Row>
                  ...
                  <div className=" line-head line-border">
                        <div className=" row">
                            ...
                            <div class="circle-new-head2">
                              <i class="icon-feather-user"></i>
                            </div>
                            </div>
                            <div className=" col-lg-10 line-head">
                            <strong>Anjali Bagla</strong><br></br>
                  ...
                  <div className="line-head">
                     <strong>Skill Sets</strong><br></br>
                     <small>Loren Ipsum</small>
                    </div>
                  </Col>
                  <Col lg={2} xs={12}>
